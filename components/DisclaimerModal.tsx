                        ...
                        >
                            ...
                            <div className="p-6">
                                <p className="text-gray-900 font-medium mb-4">
                                    This platform is a demonstration prototype designed and built for Becton, Dickinson and Company management reporting and financial analytics.
                                </p>

                                <div className="space-y-3 mb-5">
                                    <div className="flex items-start space-x-2">
                                        <div className="w-1.5 h-1.5 bg-[#003087] rounded-full mt-1.5 flex-shrink-0" />
